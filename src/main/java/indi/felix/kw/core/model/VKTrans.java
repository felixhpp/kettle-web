 ...
 * 作者姓名           修改时间           版本号              描述
 */
package indi.felix.kw.core.model;
...
public class VKTrans {
    ...
    public void setQuartzDescription(String quartz_description) {
        this.quartzDescription = quartz_description;
    }
    ...
    public void setQuartzCron(String quartz_cron) {
        this.quartzCron = quartz_cron;
    }
}